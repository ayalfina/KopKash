...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::post('/store', [StocksController::class, 'create'])->name('store');
	Route::get('{id}/edit', [StocksController::class, 'edit']);
	Route::post('update/{id}', [StocksController::class, 'update']);
